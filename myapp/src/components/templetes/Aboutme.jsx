    ...
    return (
        <Wrap>
            ...
            <div className='Answers'>
                <h3>Q : 블록체인 기반 풀스택 개발자 선택하는 이유는 무엇인가요? </h3>
                <p>> 저는 문제를 처음부터 끝까지 주도적으로 해결하고 싶은 마음 때문에 풀스택 개발을 선택했습니다.
                    ...
                    추가적으로 블로체인 기술 배우면 BITCOIN, ETHEREUM 같은 네트워크에서 체인과 스마트 컨트랙트를 배우게 되어 
                    블록체인 기술도 제공할수 있다고 생각합니다. 
                 </p>
            </div>
            <div className='Answers'>
                ...
                <p>> 팀원과 원활히 소통하고 협업하려는 열린 태도,
                    ...
                    웹 개발은 기술 변화가 빠르고 팀 작업이 필수이기 때문에 
                    이러한 특성을 가진 분들이 더 좋은 품질의 결과물을 만들고 팀에 긍정적인 영향을 준다고 생각합니다.
                 </p>
            </div>
            <div className='Answers'>
                <h3>Q : 자기개발을 위해서 어떤 노력을 해왔는지? </h3>
                <p>> 저는 개발자로서 성장하기 위해 지속적인 학습과 실습을 중요하게 생각해왔습니다.
                    온라인 강의, 기술문서, 유튜브 같은거 활용해서 최신 기술과 클린코드 같은 주제를 꾸준히 공부하고있습니다.
